...
public class ScanResponseType  extends gov.loc.www.zing.srw.ResponseType  implements java.io.Serializable {
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.loc.gov/zing/srw/", "termsType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.loc.gov/zing/srw/", "echoedScanRequestType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
