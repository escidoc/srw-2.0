 ...
 */
package de.escidoc.sb.srw.util;
...
public class HttpRequester {
    ...
    private String requestSsl(
        ...
        if (securityHandle != null && !securityHandle.equals("")) {
            String encoding =
                new sun.misc.BASE64Encoder().encode(securityHandle.getBytes());
            con.setRequestProperty("Authorization", "Basic " + encoding);
            // Set Cookie
            con.setRequestProperty("Cookie", "escidocCookie=" + securityHandle);
        }
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(
        							is, Constants.CHARACTER_ENCODING));
