...
public class SRUServerTester {
    ...
    public String test() {
        ...
        if(explainDoc!=null) {
            ...
            Node   node;
            String index=null, scanResponse, set, term;
    ...
    public Term getTerm(String index, String relation, String term, Document scanDoc) {
        ...
        return new Term(index, relation, getNodeText(terms.item(0), null), getNodeText(postings.item(0), null));
    }
    ...
    public boolean search(Term term) {
        Document doc;
        String   resp;
