 ...
 */
    ...
    private String getWsdl() {
        ...
        + "                         <element maxOccurs=\"1\" minOccurs=\"0\" name=\"recordXPath\" type=\"xsd:string\"/>"
        + "                         <element maxOccurs=\"1\" minOccurs=\"0\" name=\"resultSetTTL\" type=\"xsd:nonNegativeInteger\"/>"
        + "                         <element maxOccurs=\"1\" minOccurs=\"0\" name=\"sortKeys\" type=\"xsd:anyURI\"/>"
        ...
        + "          </complexContent>"
        + "         </complexType>"
        + "         <complexType name=\"echoedExplainRequest\">"
        + "          <complexContent>"
        + "           <extension base=\"tns2:RequestType\">"
        + "            <sequence>"
        + "             <element maxOccurs=\"1\" minOccurs=\"0\" name=\"recordPacking\" type=\"xsd:string\"/>"
        ...
        + "             <element maxOccurs=\"1\" minOccurs=\"0\" name=\"echoedExplainRequest\" type=\"tns1:echoedExplainRequest\"/>"
        + "             <element maxOccurs=\"1\" minOccurs=\"0\" name=\"diagnostics\" type=\"tns1:diagnosticsType\"/>"
        + "             <element maxOccurs=\"1\" minOccurs=\"0\" name=\"extraResponseData\" type=\"tns1:extraDataType\"/>"
        + "            </sequence>"
        + "           </extension>"
        ...
        + "        <wsdl:part name=\"request\" type=\"tns1:ExplainRequestType\"/>"
        + "     </wsdl:message>"
        + "     <wsdl:message name=\"explainOperationResponse\">"
        + "        <wsdl:part name=\"explainOperationReturn\" type=\"tns1:ExplainResponseType\"/>"
        + "     </wsdl:message>"
        ...
        + "    </wsdl:operation>"
        + "  </wsdl:portType>"
        + "        <wsdl:portType name=\"ExplainSoapBindingImpl\">"
        + "        <wsdl:operation name=\"explainOperation\" parameterOrder=\"request\">"
        ...
        + "    </wsdl:operation>"
        + "  </wsdl:binding>"
        + "        <wsdl:binding name=\"ExplainSOAPSoapBinding\" type=\"impl:ExplainSoapBindingImpl\">"
        + "        <wsdlsoap:binding style=\"rpc\" transport=\"http://schemas.xmlsoap.org/soap/http\"/>"
        + "        <wsdl:operation name=\"explainOperation\">"
        + "           <wsdlsoap:operation soapAction=\"\"/>"
        + "           <wsdl:input name=\"explainOperationRequest\">"
        + "              <wsdlsoap:body encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\" namespace=\"gov.loc.www.zing\" use=\"encoded\"/>"
        + "           </wsdl:input>"
        ...
        + "      <wsdlsoap:address location=\"http://localhost:8080/srw/search/escidoc_all\"/>"
        + "    </wsdl:port>"
        + "  </wsdl:service>"
        + "        <wsdl:service name=\"ExplainSoapBindingImplService\">"
        + "        <wsdl:port binding=\"impl:ExplainSOAPSoapBinding\" name=\"ExplainSOAP\">"
        + "           <wsdlsoap:address location=\"http://localhost:8080/axis/services/ExplainSOAP\"/>"
        + "        </wsdl:port>"
        + "     </wsdl:service>"
        + "</wsdl:definitions>";
    }
